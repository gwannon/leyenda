...
mainloop
 ...
 if minotauro > 0 && hitted = 0 && collision(player1,player0) && hasshield = 0 then drawscreen : goto mainloop
 if minotauro = 0 && collision(player1,player0) && hascoin = 0 then hascoin = 1 : score = score + coinvalue : gosub colocarmoneda 
...
colocarmoneda
 ...
 randnumber = rand
 if hascoin = 0 && randnumber <= 64 then player1x = 28 : player1y = 22
 if hascoin = 0 && randnumber > 65 && randnumber <= 128 then player1x = 118 : player1y = 22
 if hascoin = 0 && randnumber > 129 && randnumber <= 192 then player1x = 28 : player1y = 77
 if hascoin = 0 && randnumber > 193 && randnumber <= 255 then player1x = 118 : player1y = 77
 return
...
moverenemigo
 if minotauro > 0 && player1y = 22 && player1x < 118 then player1x = player1x + 1  
 if minotauro > 0 && player1y = 77 && player1x > 28 then player1x = player1x - 1 
 if minotauro > 0 && player1x = 118 && player1y < 77 then player1y = player1y + 1 
 if minotauro > 0 && player1x = 28 && player1y > 22 then player1y = player1y - 1 
 return
